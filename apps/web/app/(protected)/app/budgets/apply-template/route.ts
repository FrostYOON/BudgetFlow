...
import { applyBudgetTemplate } from "@/lib/budgets";
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    return NextResponse.redirect(new URL(`/app/budgets?year=${year}&month=${month}&toast=budget_template_applied`, request.url));
  } catch {
